...
/**
 * Class CliProgressBar 进度条
 * https://github.com/dariuszp/cli-progress-bar
 * @package Dariuszp
 */
class CliProgressBar
{
     ...
     * @return $this
     */
    public function setProgressTo(int $currentStep)
    {
     ...
     * @return $this
     */
    public function addCurrentStep(int $currentStep)
    {
